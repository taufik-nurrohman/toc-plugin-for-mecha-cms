<form class="form-plugin" action="<?php $toc_config = File::open(__DIR__ . DS . 'states' . DS . 'config.txt')->unserialize(); $toc_css = File::open(__DIR__ . DS . 'assets' . DS . 'shell' . DS . 'toc.css')->read(); echo $config->url_current; ?>/update" method="post">
